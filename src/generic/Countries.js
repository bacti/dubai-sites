const countries = [
    ...
    {"id":"SN", "value":"Senegal"},
    {"id":"CS", "value":"Serbia and Montenegro"},
...
export const ListCountries = _ => {return countries};
export const GetCountryName = id => countries[id];
export const GetCountryID = name => (countries.find(e => e.value==name).id);